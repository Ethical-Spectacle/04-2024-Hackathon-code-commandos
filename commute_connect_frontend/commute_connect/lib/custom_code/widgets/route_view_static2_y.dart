...
class RouteViewStatic2Y extends StatefulWidget {
  const RouteViewStatic2Y({
    Key? key,
    this.width,
    this.height,
  }) : super(key: key);
...
class _RouteViewStaticState extends State<RouteViewStatic2Y> {
  ...
  Future<bool> _calculateDistance() async {
    ...
    try {
      ...
      double startLatitude2 = 33.415724035194486;
      double startLongitude2 = -111.79071508468012;
      double destinationLatitude2 = 33.306215432072534;
      double destinationLongitude2 = -111.67849161350222;
      ...
      Marker dm2 = Marker(
        ...
        position: latlng.LatLng(destinationLatitude2, destinationLongitude2),
        infoWindow: InfoWindow(
