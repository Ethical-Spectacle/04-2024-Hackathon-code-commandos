...
import 'app_onboarding_model.dart';
export 'app_onboarding_model.dart';

class AppOnboardingWidget extends StatefulWidget {
  const AppOnboardingWidget({super.key});
...
class _AppOnboardingWidgetState extends State<AppOnboardingWidget>
  ...
  late AppOnboardingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppOnboardingModel());
  }
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            44.0, 8.0, 44.0, 0.0),
                        child: Text(
                          'Reach your destination on time, always using a multitude of public transportation + taxi. Save money & save environment.',
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('App-Onboarding-2');
                          },
                          text: 'Get Started',
